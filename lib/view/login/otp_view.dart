    ...
    try {
      await auth.verifyPhoneNumber(
        ...
        verificationFailed: (error) {
          mdShowAlert("Echec", error.toString(), () {});
        },
      ...
      mdShowAlert("Echec", e.toString(), () {});
    }
  }

  void smsVerification() async {
    if (otpCode.length < 6) {
      mdShowAlert("Erreur", "Veuillez entrez un code valide", () {});
      return;
    }
    ...
    try {
      ...
      if (user != null) {
        ...
        mdShowAlert("Erreur", "OTP incorrect", () {});
      }
    } catch (e) {
      mdShowAlert("Erreur", e.toString(), () {});
    }
  }
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Entrer le code a 6-chiffres que vous aviez reçu",
                  style: TextStyle(
